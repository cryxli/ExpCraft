...
public class LCFarming extends JavaPlugin {
	...
	public File ConfigurationFile = new File(
			"plugins/LevelCraftCore/Configs/Farming.cfg");
	...
	public void onEnable() {
		...
		String[] Unlocks = { "Wooden Hoe = " + this.LCConfiguration.WoodHoe,
				"Stone Hone = " + this.LCConfiguration.StoneHoe,
				"Iron Hoe = " + this.LCConfiguration.IronHoe,
				"Gold Hoe = " + this.LCConfiguration.GoldHoe,
				"Diamond Hoe = " + this.LCConfiguration.DiamondHoe };
		...
		int[] UnlocksLevel = { this.LCConfiguration.WoodHoe,
				this.LCConfiguration.StoneHoe, this.LCConfiguration.IronHoe,
				this.LCConfiguration.GoldHoe, this.LCConfiguration.DiamondHoe };
		...
		String[] Exp = {
				...
				"Exp Per Yellow Flower"
						+ this.LCConfiguration.ExpPerYellowFlower,
