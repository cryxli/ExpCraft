...
public class Language {
	...
	public void LoadLang() {
		...
		this.LevelSetSuccess = properties.getString("LevelSetSuccess","Level set successfully.");
		this.LevelSetFalse = properties.getString("LevelSetFalse","Could not set level please check log.");
		this.ExperienceSetSuccess = properties.getString("ExperienceSetSuccess", "Experience set successfully.");
		this.ExperienceSetFalse = properties.getString("ExperienceSetFalse.", "Could not set experience please check log.");
		this.ExperienceResetSuccess = properties.getString("ResetSuccess", "Experience reset successfully.");
		this.ExperienceResetFalse = properties.getString("ResetFalse", "Could not reset experience.");
		this.NoMatch = properties.getString("NoPlayer","No matching player.");
		this.TooMany = properties.getString("ManyPlayer", "Too many players. Be more specific");
		this.ExperienceIs= properties.getString("ExperienceIs", " experience is ");
		this.LevelIs = properties.getString("LevelIs", " level is "); 
		this.SyntaxA = properties.getString("AdminSyntax", "Syntax Error. See /level admin. For help.");
		this.ShowsThis = properties.getString("ShowsThis", "Shows this.");
		this.ResetExperience = properties.getString("ResetExperience","Resets experience for player.");
		this.GetLevelOfPlayer = properties.getString("LevelOfPlayer","Gets level of player.");
		this.GetExperienceOfPlayer = properties.getString("ExperienceOfPlayer", "Gets experience for player.");
		this.SetLevelForPlayers = properties.getString("SetLevelOfPlayer", "Sets level for player.");
		...
		this.NotifyOff = properties.getString("NotifyOff", "Experience notify disabled.");			
		...
		this.ExperienceToNextLevel = properties.getString("ExperienceToNextLevel", "Experience to next level: ");		
		this.YourActiveLevels = properties.getString("ActiveLevels", "Your Active Levels are: ");
		this.NoHelpFileYet = properties.getString("NoHelp", "No Help file for level yet.");
		this.SyntaxP = properties.getString("PlayerSyntax", "Wrong Syntax. Please use '/level' for more infomation.");	
		this.YouDoNotHavePermission = properties.getString("NoPermissions","You do not have permission to do that.");
		this.TopPlayersIn = properties.getString("TopPlayer","Top Players In");
		this.YouAreNumber = properties.getString("YouNumber","You are number ");
		this.TotalExp= properties.getString("TotalExp","Total Experience: ");
		this.TotalLevel= properties.getString("TotalLevel","Total Level: ");
		this.HighestLevel = properties.getString("HighestLevel","Highest Level: ");
		this.None = properties.getString("None","No stat/command found.");
		this.ClassCommands = properties.getString("ClassCommands","Class Commands");
		this.ShowsActive= properties.getString("ShowActive","Shows active stats.");
		this.ToggleNote= properties.getString("ToogleNote","Toggles notifications.");
		this.ShowsLevelStats= properties.getString("ShowLevelStats","Shows Level Statistics.");
		this.ShowsToolBlock= properties.getString("ShowsToolBlock","Shows Tool and Block unlocks.");
		this.ShowsExp= properties.getString("ShowsExp","Shows Experience For Actions.");
		this.Shout = properties.getString("ShowShout", "Shouts Level Statistics.");
		this.ShowsTotal= properties.getString("ShowsTotal","Shows total Level.");
		...
		this.ShowsTop= properties.getString("ShowsTop","Shows top players in that level.");
		this.ShowsHelp= properties.getString("ShowsHelp","Gets help on a level.");
		this.AdminCommands= properties.getString("AdminCommands","Admin Commands.");
	}
}
