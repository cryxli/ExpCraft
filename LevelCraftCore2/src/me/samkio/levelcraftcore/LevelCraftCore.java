...
public class LevelCraftCore extends JavaPlugin {
	...
	public final Class Class = new Class(this);
	...
	public boolean AllowClassSwitch;
	public boolean ResetOnClassSwitch;
	public String SwitchableClasses;
...
*/
    ...
    public boolean Reload(){
		...
		this.lang.LoadLang();
		if(this.UseClasses) this.Class.load();
	...
	public void loadConfig() {
		...
		this.UseClasses = gC.getBoolean("UseClassSystem", true);
		this.AllowClassSwitch = gC.getBoolean("AllowClassSwitching", false);
		this.ResetOnClassSwitch = gC.getBoolean("ResetExpOnClassSwitch", false);
		this.SwitchableClasses = gC.getString("SwitchableClasses", "Warrior,Mage,Farmer,Lumberjack,Miner");
	...
	public void registerEvents() {
		...
		if(EnableSkillMastery||UseClasses){
