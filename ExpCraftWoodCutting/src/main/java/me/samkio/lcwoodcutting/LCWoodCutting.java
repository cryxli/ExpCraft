...
public class LCWoodCutting extends JavaPlugin {
	...
	public File ConfigurationFile = new File(
			"plugins/LevelCraftCore/Configs/WoodCutting.cfg");
	...
	public void onEnable() {
		...
		// Set Unlocks Data
		String[] Unlocks = { "Wooden Hatchet = " + LCConfiguration.WoodAxe,
				"Stone Hatchet = " + LCConfiguration.StoneAxe,
				"Iron Hatchet = " + LCConfiguration.IronAxe,
				"Gold Hatchet = " + LCConfiguration.GoldAxe,
				"Diamond Hatchet = " + LCConfiguration.DiamondAxe };
		getConfiguration().setProperty("LevelUnlocks", Unlocks);
		String[] Exp = { "Exp Per Plank " + LCConfiguration.ExpPerPlank,
				"Exp Per Log " + LCConfiguration.ExpPerLog };
		int[] UnlocksLevel = { LCConfiguration.WoodAxe,
				LCConfiguration.StoneAxe, LCConfiguration.IronAxe,
				LCConfiguration.GoldAxe, LCConfiguration.DiamondAxe };
